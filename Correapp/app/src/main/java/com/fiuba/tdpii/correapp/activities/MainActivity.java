        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(destinynLocation == null){
                    Toast.makeText(MainActivity.this,"No se encontro localidad",Toast.LENGTH_SHORT).show();
                    return false;
                } else {
                    Intent navigationIntent = new Intent(MainActivity.this, MapActivity.class);
